...
module.exports = {
	name: 'fm',
	description: 'Get users two most recent tracks from lastfm!',
            ...
            message.channel.send({
              embed: {
                ...
                fields: [{
                    ...
                    {
                        name: "Previous Song:",
                        value: "["+lastfm.recenttracks.track[1].name+"]("+lastfm.recenttracks.track[1].url+")",
                        inline: true
                    },
                    {
                        name: "Previous Artist:",
                        value: "["+lastfm.recenttracks.track[1].artist.name+"]("+lastfm.recenttracks.track[1].artist.url+")",
                        inline: true
                    },
                    {
                        name: "‌‌ ",
